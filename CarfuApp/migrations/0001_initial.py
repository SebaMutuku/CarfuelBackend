# Generated by Django 4.1.2 on 2022-10-29 13:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imageUrl', models.ImageField(blank=True, upload_to='images/%Y/%m/%d', validators=[django.core.validators.FileExtensionValidator(['png', 'jpg', 'gif', 'jpeg'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userid', models.OneToOneField(blank=True, db_column='pk', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
